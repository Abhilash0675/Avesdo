...
public class TestCreateNewDeal extends BaseTest {
	...
	public void addRealtor() throws Exception{
		TestRealtorPage testRealtorPage = new TestRealtorPage(driver,configurationReader,browserName);
		boolean status = testRealtorPage.addRealtor();
		handleAssert(status);
	}*/
	...
	public void toVerify() throws Exception{
		TestToVerifyPage testToVerifyPage = new TestToVerifyPage(driver,configurationReader,browserName);
		boolean status = testToVerifyPage.toVerify();
		handleAssert(status);
	}*/
